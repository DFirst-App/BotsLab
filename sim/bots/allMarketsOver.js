(() => {
  class SimAllMarketsOverBot {
    ...
    async start(config) {
      ...
      this.ui.showStatus('Simulation mode: Starting Over 0 sequence...', 'success');
      this.isRunning = true;
      this.stopRequested = false;
    ...
    queueNextTrade() {
      ...
      this.ui.updateTargets(market, 'Over 0');
  ...
  window.SimAllMarketsOverBot = SimAllMarketsOverBot;
})();
