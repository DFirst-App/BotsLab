(() => {
  class SimRiseFallBot {
    ...
    async start(config) {
      ...
      this.ui.showStatus('Simulation mode: Starting Rise/Fall Pro...', 'success');
      this.isRunning = true;
      this.stopRequested = false;
    ...
    queueNextTrade() {
      ...
      // Simulate momentum-confirmed: randomly choose CALL or PUT
    ...
    executeTrade(direction) {
      ...
      const win = this.simBase.simulateTrade(direction);
      ...
      setTimeout(() => this.queueNextTrade(), 600);
    }
  ...
  window.SimRiseFallBot = SimRiseFallBot;
})();
