...
(function() {
  ...
  function showConfirmDialog(title, message, onConfirm, onCancel = null) {
    ...
    if (!document.body) {
      ...
      setTimeout(() => showConfirmDialog(title, message, onConfirm, onCancel), 100);
      return null;
    }
    ...
    const popup = document.createElement('div');
    popup.className = 'popup-notification popup-confirm';
    ...
    confirmBtn.onmouseover = () => {
      confirmBtn.style.background = 'rgba(255, 95, 109, 0.25)';
      confirmBtn.style.borderColor = 'rgba(255, 95, 109, 0.8)';
      confirmBtn.style.transform = 'translateY(-2px)';
    };
    confirmBtn.onmouseout = () => {
      confirmBtn.style.background = 'rgba(255, 95, 109, 0.15)';
      confirmBtn.style.borderColor = 'rgba(255, 95, 109, 0.6)';
    ...
    try {
      ...
      console.error('Error appending confirmation popup:', error);
      return null;
    }
